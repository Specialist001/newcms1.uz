...
Route::get('/backend/resources/(name:any)/create/', [
    'controller' => 'ResourceController',
    'action'     => 'create'
]);

Route::get('/backend/resources/(name:any)/edit/(id:numeric)', [
    'controller' => 'ResourceController',
    'action'     => 'edit'
]);

Route::post('/backend/resources/add/', [
    'controller' => 'ResourceController',
    'action'     => 'add'
]);

Route::post('/backend/resources/update/', [
    'controller' => 'ResourceController',
    'action'     => 'update'
]);
